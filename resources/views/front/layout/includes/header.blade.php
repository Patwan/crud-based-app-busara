    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <!-- Logo -->
                <div class="logo">
                  <h1><a href="#">Client Dashboard</a></h1>
                </div>
            </div>
            ...
            <div class="col-md-3 pull-right">
                ...
                <div class="navbar navbar-inverse" role="banner">
                    <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                 <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Welcome {{Auth::user()->name}} <b
                                            class="caret"></b></a>
                ...
                <a href='{{ route('get.login') }}' class='btn btn-default'>  LogIn </a>
